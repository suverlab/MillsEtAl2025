...
baseDirectory = '/Users/millskm/Desktop/Vanderbilt/SuverLab - Analysis/wbaAnalysis/' # Main Folder
matDirectory = '/Users/millskm/Desktop/Vanderbilt/SuverLab - Analysis/wbaAnalysis/mat/' # Folder in which all .mat files are placed
...
config_path['dorsal'] = DLCDirectory + 'fancyRig-wba-DLC-2025-03-20/config.yaml'
...
angPairs['dorsal'] = [(0,1),(2,3)] # L wing, R wing
...
angPairs_byAntenna['dorsal'] = [0,1] # L, R
